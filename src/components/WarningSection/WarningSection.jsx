...
export default function WarningSection() {
    return (
        <section className='text-center bg-gradient-to-b from-cyan to-blue2 py-6'>
            <div className='text-white bg-logo-bg bg-bottom bg-cover'>
                ...
                <p className='my-4 px-8 font-semibold'>Para mais informações, consulte nossa <a className='text-blue1  border-b-2' href="/">política de privacidade e termos de uso</a>.</p>
            </div>
        </section>
    )
}
